  ...
  const sections = [
    {
      ...
      description:
        "Transform from Beginner to Closer in Just 4 Months. Master real-world selling, earn high income, and build unshakeable confidence.",
    ...
    },
    {
      ...
      description:
        "2 Months of rigorous offline training with sales call breakdowns, simulations, real pitching, and high-pressure challenge days.",
    ...
    },
    {
      ...
      subtitle: "INTERNSHIP",
      description:
        "2 Months working with real companies. Experience inbound & outbound selling, master CRM systems, and handle live leads.",
    ...
    },
    {
      ...
      subtitle: "PROTOCOL",
      description:
        "Master Hustlify's proven closing framework from 'Hello' to 'Paid'. Handle objections with confidence and close ₹50K+ deals.",
      ...
      <div className="h-auto flex flex-col lg:flex-row items-center justify-between px-6 lg:px-16 py-12 gap-12">
        ...
        <div className="w-full lg:w-1/2 max-w-2xl text-center lg:text-left">
          <motion.span
            ...
            className="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold bg-gradient-to-r from-gray-800 to-gray-700 text-white border border-gray-600 shadow-lg mb-4"
          >
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-4xl sm:text-5xl lg:text-7xl font-black text-white mb-4 leading-tight">
                {section.title}
              </h2>
              <h2
                className={`text-2xl sm:text-4xl lg:text-5xl font-light mb-6 bg-gradient-to-r ${section.accent} bg-clip-text text-transparent`}
              >
                {section.subtitle}
              </h2>
        ...
        <motion.div
          ...
          exit={{ opacity: 0, x: -20 }}
          transition={{ duration: 0.5 }}
          className="w-full lg:w-1/2 flex justify-center items-center h-auto lg:h-auto"
        >
              ...
              <div className="w-full h-[600px] overflow-hidden bg-gradient-to-b from-gray-100 to-gray-50 rounded-[2.5rem] relative">
                ...
                <div className="h-full overflow-hidden px-4 rounded-full py-6">
                  <div className="text-center py-6">
                    <div
                      className={`w-16 h-16 bg-gradient-to-r ${section.accent} rounded-full mx-auto mb-4 flex items-center justify-center`}
                    >
                  ...
                  <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-6 text-white border border-gray-700 shadow-2xl">
                    ...
                    <button
                      className={`w-full bg-gradient-to-r ${section.accent} text-black rounded-xl py-3 font-bold mb-2 shadow-lg`}
                    >
                      {currentSection === 0
                        ? 'START TRAINING'
                        : currentSection === 1
