...
const Hero = () => {
  return (
    <section className="relative bg-transparent text-white min-h-[100vh] px-6 md:px-17 py-20 font-sans bg-cover bg-center">
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <a href="#contact">
              <button className="bg-gradient-to-r from-gray-200 to-gray-300 text-black px-6 py-2 rounded-full font-semibold hover:scale-105 transition">
                Join us – now!
              </button>
            </a>
          </div>
